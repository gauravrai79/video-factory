...
def script(channel, cast_chars: list, idea: dict[str, Any], *, model: str | None = None,
    ...
    user = (
        ...
        "WARDROBE — HARD RULE: NEVER write what a CAST character looks like or is WEARING. Their "
        "face, build, costume and colours are locked and injected automatically from the character "
        "sheet. Writing something like 'Zruv in a bright orange tank top' OVERRIDES his real costume "
        "and ruins the render. For cast characters describe ONLY what they DO: pose, gesture, "
        "expression, where they stand, what they hold or touch. (Background extras you invent may "
        "have clothing described.) Make `camera` specific: shot size + angle (movement belongs to "
        "the video stage).\n"
